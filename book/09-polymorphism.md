...
![](https://cdn.jsdelivr.net/gh/reniie/OnJava8@publish/images/1561774164644.png)
...
![](https://cdn.jsdelivr.net/gh/reniie/OnJava8@publish/images/1562252767216.png)
...
![](https://cdn.jsdelivr.net/gh/reniie/OnJava8@publish/images/1562406479787.png)
...
![](https://cdn.jsdelivr.net/gh/reniie/OnJava8@publish/images/1562409366638.png)
...
![](https://cdn.jsdelivr.net/gh/reniie/OnJava8@publish/images/1562409366637.png)

虽然这是一种有用且明智的方法（依赖具体情况），但是也存在缺点。派生类中接口的扩展部分在基类中不存在（不能通过基类访问到这些扩展接口），因此一旦向上转型，就不能通过基类调用这些新方法：

![](https://cdn.jsdelivr.net/gh/reniie/OnJava8@publish/images/1562409926765.png)
