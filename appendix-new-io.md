...
![](https://cdn.jsdelivr.net/gh/reniie/OnJava8@master/images/1554546258113.png)
...
![](https://cdn.jsdelivr.net/gh/reniie/OnJava8@master/images/1554546378822.png)
...
![](https://cdn.jsdelivr.net/gh/reniie/OnJava8@master/images/1554546452861.png)
...
![](https://cdn.jsdelivr.net/gh/reniie/OnJava8@master/images/1554546627710.png)
...
![](https://cdn.jsdelivr.net/gh/reniie/OnJava8@master/images/1554546666685.png)

两个相对 `get()` 调用将前两个字符的值保存在变量 `c1` 和 `c2` 中。在这两个调用之后，缓冲区看起来是这样的：

![](https://cdn.jsdelivr.net/gh/reniie/OnJava8@master/images/1554546693664.png)

为了执行交换，我们在位置 0 处编写 `c2`，在位置 1 处编写 `c1`。我们可以使用绝对 `put()` 方法来实现这一点，或者用 `reset()` 方法，将 position 的值设置为 mark：

![](https://cdn.jsdelivr.net/gh/reniie/OnJava8@master/images/1554546847181.png)

两个 `put()` 方法分别编写 `c2` 和 `c1` ：

![](https://cdn.jsdelivr.net/gh/reniie/OnJava8@master/images/1554546861836.png)

在下一次循环中，将 mark 设置为 position 的当前值：

![](https://cdn.jsdelivr.net/gh/reniie/OnJava8@master/images/1554546881189.png)
...
![](https://cdn.jsdelivr.net/gh/reniie/OnJava8@master/images/1554546890132.png)
